    ...
    fetch_items:function(frm) {
        ...
        if (frm.doc.from_doctype =='Purchase Receipt') {
            erpnext.utils.map_current_doc({
                method: "automobile_sales.api.make_custom_card_from_purchase_receipt",
                source_name:frm.doc.from_docname,
                target: frm
            })            
        } else if(frm.doc.from_doctype =='Purchase Order'){
            erpnext.utils.map_current_doc({
                method: "automobile_sales.api.make_custom_card_from_purchase_order",
                source_name:frm.doc.from_docname,
                target: frm
            })
        } else if(frm.doc.from_doctype =='Car Stock Entry'){
            erpnext.utils.map_current_doc({
                method: "automobile_sales.api.make_custom_card_from_car_stock_entry",
                source_name:frm.doc.from_docname,
                target: frm
            })
        }
...
frappe.ui.form.on(cur_frm.doctype, {
    search_group: function (frm) {
        if (cur_frm.doc.search_group) {
            frappe.call({
                method: "automobile_sales.api.get_template_name",
                args: {
    ...
    search_template: function (frm) {
        frappe.call({
            method: "automobile_sales.api.get_category_name",
            args: {
    ...
    search_category: function (frm) {
        frappe.call({
            method: "automobile_sales.api.get_model_name",
            args: {
                search_template: cur_frm.doc.search_template,
    ...
    search_model: function (frm) {
        frappe.call({
            method: "automobile_sales.api.get_color_name",
            args: {
                search_template: cur_frm.doc.search_template,
                search_category: cur_frm.doc.search_category,
    ...
    add: function (frm) {
        ...
        frappe.call({
            method: "automobile_sales.api.get_search_item_name",
            args: {
                search_template: cur_frm.doc.search_template,
                search_category: cur_frm.doc.search_category,
                search_model: cur_frm.doc.search_model,
